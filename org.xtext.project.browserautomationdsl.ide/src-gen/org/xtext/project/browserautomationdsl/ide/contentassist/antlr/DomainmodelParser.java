...
public class DomainmodelParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, DomainmodelGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getVERIFYAccess().getAlternatives_4(), "rule__VERIFY__Alternatives_4");
			...
			builder.put(grammarAccess.getGOTOAccess().getGroup_2_0(), "rule__GOTO__Group_2_0__0");
			builder.put(grammarAccess.getGOTOAccess().getGroup_2_1(), "rule__GOTO__Group_2_1__0");
			...
			builder.put(grammarAccess.getFILLAccess().getGroup_4_1(), "rule__FILL__Group_4_1__0");
			...
			builder.put(grammarAccess.getVERIFYAccess().getGroup_4_0(), "rule__VERIFY__Group_4_0__0");
			builder.put(grammarAccess.getVERIFYAccess().getGroup_4_1(), "rule__VERIFY__Group_4_1__0");
			builder.put(grammarAccess.getPLAYAccess().getGroup(), "rule__PLAY__Group__0");
			builder.put(grammarAccess.getPLAYAccess().getGroup_4(), "rule__PLAY__Group_4__0");
			...
			builder.put(grammarAccess.getGOTOAccess().getValAssignment_2_0_1(), "rule__GOTO__ValAssignment_2_0_1");
			builder.put(grammarAccess.getGOTOAccess().getValAssignment_2_1_1(), "rule__GOTO__ValAssignment_2_1_1");
			builder.put(grammarAccess.getFILLAccess().getVarAssignment_4_0_1(), "rule__FILL__VarAssignment_4_0_1");
			builder.put(grammarAccess.getFILLAccess().getValueAssignment_4_1_1(), "rule__FILL__ValueAssignment_4_1_1");
			builder.put(grammarAccess.getSELECTAccess().getElemAssignment_2(), "rule__SELECT__ElemAssignment_2");
			builder.put(grammarAccess.getSAVEVARAccess().getVarAssignment_3(), "rule__SAVEVAR__VarAssignment_3");
			builder.put(grammarAccess.getVERIFYAccess().getValueAssignment_4_1_1(), "rule__VERIFY__ValueAssignment_4_1_1");
			builder.put(grammarAccess.getPLAYAccess().getParamsAssignment_4_1(), "rule__PLAY__ParamsAssignment_4_1");
		}
	}
