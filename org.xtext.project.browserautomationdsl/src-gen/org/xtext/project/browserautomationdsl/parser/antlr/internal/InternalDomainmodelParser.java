...
public class InternalDomainmodelParser extends AbstractInternalAntlrParser {
    public static final String[] tokenNames = new String[] {
        "<invalid>", "<EOR>", "<DOWN>", "<UP>", "RULE_VARTYPE", "RULE_STRING", "RULE_INT", "RULE_ID", "RULE_ML_COMMENT", "RULE_SL_COMMENT", "RULE_WS", "RULE_ANY_OTHER", "'procedure'", "'with'", "'open'", "'FIREFOX'", "'CHROME'", "'go'", "'to'", "'\"'", "'givenHA'", "'click'", "'on'", "'BUTTON'", "'LINK'", "'IMAGE'", "'TEXT'", "'fill'", "'TEXTFIELD'", "'SEARCHFIELD'", "'saved'", "'check'", "'all'", "'CHECKBOX'", "'uncheck'", "'select'", "'in'", "'COMBOBOX'", "'read'", "'url'", "'from'", "'identified'", "'by'", "'LABEL'", "'CLASS'", "'ID'", "'ALT'", "'count'", "'ELEMENT'", "'and'", "'save'", "'verify'", "'that'", "'PAGE'", "'contains'", "'play'"
    };
    ...
    // InternalDomainmodel.g:359:1: ruleGOTO returns [EObject current=null] : (otherlv_0= 'go' otherlv_1= 'to' ( (otherlv_2= '\"' ( (lv_val_3_0= RULE_VARTYPE ) ) otherlv_4= '\"' ) | (otherlv_5= 'givenHA' ( (lv_val_6_0= RULE_VARTYPE ) ) ) ) ) ;
    public final EObject ruleGOTO() throws RecognitionException {
        ...
        try {
            // InternalDomainmodel.g:365:2: ( (otherlv_0= 'go' otherlv_1= 'to' ( (otherlv_2= '\"' ( (lv_val_3_0= RULE_VARTYPE ) ) otherlv_4= '\"' ) | (otherlv_5= 'givenHA' ( (lv_val_6_0= RULE_VARTYPE ) ) ) ) ) )
            // InternalDomainmodel.g:366:2: (otherlv_0= 'go' otherlv_1= 'to' ( (otherlv_2= '\"' ( (lv_val_3_0= RULE_VARTYPE ) ) otherlv_4= '\"' ) | (otherlv_5= 'givenHA' ( (lv_val_6_0= RULE_VARTYPE ) ) ) ) )
            {
            // InternalDomainmodel.g:366:2: (otherlv_0= 'go' otherlv_1= 'to' ( (otherlv_2= '\"' ( (lv_val_3_0= RULE_VARTYPE ) ) otherlv_4= '\"' ) | (otherlv_5= 'givenHA' ( (lv_val_6_0= RULE_VARTYPE ) ) ) ) )
            // InternalDomainmodel.g:367:3: otherlv_0= 'go' otherlv_1= 'to' ( (otherlv_2= '\"' ( (lv_val_3_0= RULE_VARTYPE ) ) otherlv_4= '\"' ) | (otherlv_5= 'givenHA' ( (lv_val_6_0= RULE_VARTYPE ) ) ) )
            {
            ...
            // InternalDomainmodel.g:375:3: ( (otherlv_2= '\"' ( (lv_val_3_0= RULE_VARTYPE ) ) otherlv_4= '\"' ) | (otherlv_5= 'givenHA' ( (lv_val_6_0= RULE_VARTYPE ) ) ) )
            int alt7=2;
            ...
            switch (alt7) {
                case 1 :
                    ...
                    break;
                case 2 :
                    // InternalDomainmodel.g:405:4: (otherlv_5= 'givenHA' ( (lv_val_6_0= RULE_VARTYPE ) ) )
                    {
                    // InternalDomainmodel.g:405:4: (otherlv_5= 'givenHA' ( (lv_val_6_0= RULE_VARTYPE ) ) )
                    // InternalDomainmodel.g:406:5: otherlv_5= 'givenHA' ( (lv_val_6_0= RULE_VARTYPE ) )
                    {
                    otherlv_5=(Token)match(input,20,FOLLOW_3); 

                    					newLeafNode(otherlv_5, grammarAccess.getGOTOAccess().getGivenHAKeyword_2_1_0());
