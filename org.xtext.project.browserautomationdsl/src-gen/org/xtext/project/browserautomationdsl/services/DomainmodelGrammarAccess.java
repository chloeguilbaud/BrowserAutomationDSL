...
public class DomainmodelGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class GOTOElements extends AbstractParserRuleElementFinder {
		...
		private final Keyword cGivenHAKeyword_2_1_0 = (Keyword)cGroup_2_1.eContents().get(0);
		...
		//GOTO:
		//	'go' 'to' ('"' val=VARTYPE '"' | 'givenHA' val=VARTYPE);
		@Override public ParserRule getRule() { return rule; }
		...
		//'"' val=VARTYPE '"' | 'givenHA' val=VARTYPE
		...
		//'givenHA'
		public Keyword getGivenHAKeyword_2_1_0() { return cGivenHAKeyword_2_1_0; }
